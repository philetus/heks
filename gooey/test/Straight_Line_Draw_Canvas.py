...
class Straight_Line_Draw_Canvas(Canvas):
    """A simple line drawing application to test canvas library
    """
    ...
    def __init__(self):
        ...
        # set window title
        self._title = "canvas: straight line draw test app"
    
    def handle_quit(self):
        self.stop() # kill gtk loop when window is closed 
...
if __name__ == "__main__":
    ...
    canvas = Straight_Line_Draw_Canvas()
    gooey.show(canvas)
